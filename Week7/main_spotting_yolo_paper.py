...
from util.eval_spotting_paper import evaluate
from dataset.datasets import get_datasets
from model.model_spotting_paper import Model  # Updated import path to match the renamed file
...
def main(args):
    ...
    wandb.init(project="C6_W7", entity="C3_MCV_LGVP", name="baseline_yolo_paper")
