...
if __name__ == "__main__":
    main("Week3/aic19-track1-mtmc-train/train/S01/c001/gt/gt.txt",
          f"output/detection/S01/detections_1.txt")
    
    # "output/filtered_detection/S01/filtered_detections_1.txt"
    f"output/filtered_detection/S01/new_filtered_detections_1.txt"
